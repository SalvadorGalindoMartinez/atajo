...
public class Bicicleta {
    ...
    public static String rutaCorta(int [] camino1, int [] camino2, int []camino3) {
    	...
    	// He añadido estos dos for para que sume correctamente los otro caminos que antes no estaba sumando en su totalidad
    	...
    	// He añadido esta línea también para comprobar que hace las sumas de los caminos correctamente
    	System.out.println("camino1: " + sum1 + ", camino2: " + sum2 + ", camino3: " + sum3);
